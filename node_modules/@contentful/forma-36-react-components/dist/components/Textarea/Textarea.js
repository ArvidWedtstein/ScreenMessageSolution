...
var _excluded = ["className", "disabled", "error", "id", "maxLength", "name", "onBlur", "onChange", "onKeyDown", "placeholder", "required", "rows", "testId", "textareaRef", "value", "width", "willBlurOnEsc"];
var styles = {
