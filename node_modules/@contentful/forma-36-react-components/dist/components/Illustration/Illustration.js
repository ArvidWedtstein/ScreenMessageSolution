...
var _excluded = ["className", "testId", "illustration"];
var styles = {
...
function Illustration(_ref) {
  ...
  var illustrationComponents = {
    Archive: _svg.Archive,
    Audio: _svg.Audio,
    Richtext: _svg.Richtext,
    Code: _svg.Code,
    Image: _svg.Image,
    Markup: _svg.Markup,
    Pdf: _svg.Pdf,
    Plaintext: _svg.Plaintext,
    Presentation: _svg.Presentation,
    Spreadsheet: _svg.Spreadsheet,
    Video: _svg.Video
  };
