...
var _excluded$a = ["className", "disabled", "error", "id", "maxLength", "name", "onBlur", "onChange", "onKeyDown", "placeholder", "required", "rows", "testId", "textareaRef", "value", "width", "willBlurOnEsc"];
var styles$a = {
...
var Textarea = function Textarea(_ref) {
  ...
  var classNames = classnames(styles$a['Textarea'], className, styles$a[widthClass], (_cn = {}, _defineProperty(_cn, styles$a['Textarea--disabled'], disabled), _defineProperty(_cn, styles$a['Textarea--negative'], error), _cn));
  return /*#__PURE__*/React__default.createElement("div", {
    className: classNames
