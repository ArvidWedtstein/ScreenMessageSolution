...
export interface SpaceAPI {
    ...
    getAssets: <T = Object, InputArgs = SearchQuery>(query?: InputArgs) => Promise<CollectionResponse<T>>;
...
export interface AccessAPI {
    ...
    can<T = Object>(action: 'patch', entity: 'Asset' | 'Entry' | T, patch: JSONPatchItem[]): Promise<boolean>;
